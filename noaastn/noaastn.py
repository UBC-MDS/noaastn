def get_data(station_number, year, path=None):
    ...
    Args:
        station_number (str): The station number. for eaxample: '010015-99999' represents BRINGELAND
        year (int): The year of the data collected at the station
        path (str, optional): path of the directtory to save the dataframe. for example: "home/project/" 
